...
CPPFLAGS="-I $JAVA_HOME/include -I $JAVA_HOME/include/$OS -I $YICES_DIST/include -I/libgmp_static/dist/include"
...
LIBS="-l:libyices.$LIB_EXTENSION.$YICES_VERSION /libgmp_static/dist/lib/libgmp.a"
LD_FLAGS="-L $YICES_DIST/lib -L/libgmp_static/dist/lib"
